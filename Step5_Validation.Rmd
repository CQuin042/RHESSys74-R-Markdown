...
plot(cwws32valrss1_run1$date,cwws32valrss1_run1$rootzone.S/cwws32valrss1_run1$rootzone.potential_sat, type = "l")
...
for(i in 1:validationruns) {  assign(paste0("vsmKGEobs",i), KGE(sim = as.numeric(eval(parse(text = paste0("((valmergesm",i,"$rootzone.S","/valmergesm",i,"$rootzone.potential_sat))")))), obs = as.numeric(eval(parse(text = paste0("valmergesm",i,"$Site1"))))))
...
{plot(cwws32valrss1_run1$date, (cwws32valrss1_run1$rootzone.S/cwws32valrss1_run1$rootzone.potential_sat), type = 'l', ylim = c(0.12,0.26))
lines(valmergesm1$Date,valmergesm1$Site1, col = 'BLUE', lty = 3)}



{plot(cwws32valrss1_run3$date, (cwws32valrss1_run3$rootzone.S/cwws32valrss1_run3$rootzone.potential_sat), type = 'l', ylim = c(0.12,0.26))
