---
title: "RHESSysIOinR_Coweeta_WS7_74 Multi Site Validation Field Data_Step2"
...
\#\#spinup runs have been shortened from 1775-2018 to 2015-2018 \#spinup static
...
input_rhessys = IOin_rhessys_input(
  ...
  world_file = "CWWS7static.world",
  world_hdr_prefix = "CWWS7static",
  flowtable = "CWWS7.flow",
  start = "1775 11 1 1",
  end = "2018 11 2 1",
  output_folder = "out",
  output_prefix = "cwws7",
...
input_hdr = IOin_hdr(
  ...
  basestations = "clim/cwtws7extended.base")
...
Run Spinup \#1 Spinup runs model on one processor for x number of years. Takes a very long time. Spinup has been turned off for the purposes of this demonstration. Using previously spun up file \~ 12 hours, run multiple times.
...
input_rhessys = IOin_rhessys_input(
  version = rh_path,
  tec_file = "tecfiles/tec_daily",
  world_file = "CWWS7static.world.Y2018M11D1H1.state",
  world_hdr_prefix = "CWWS7static",
  flowtable = "CWWS7static.flow",
  start = "1775 11 1 1",
  end = "2018 11 2 1",
  output_folder = "out",
  output_prefix = "cwws7",
...
setwd(system.file("extdata/", package = "RHESSysIOinR"))
spinupoutput<- readin_rhessys_output("out/CWWS7_runspinup")

#spinupoutput<- readin_rhessys_output("out/cwws7dsm_rundsmspinup")
#spinupoutput<- readin_rhessys_output("out/cwws7ssurgo_runssurgospinup")
...
input_rhessys = IOin_rhessys_input(
  version = rh_path,
  tec_file = "tecfiles/tec_daily",
  world_file = "CWWS7ssurgo.world",
  world_hdr_prefix = "CWWS7ssurgo",
  flowtable = "CWWS7ssurgo.flow",
  start = "1775 11 1 1",
  end = "2018 11 2 1",
  output_folder = "out",
  output_prefix = "cwws7",
...
Run Spinup \#1 and \#2 Spinup runs model on one processor for x number of years. Takes a very long time. Spinup has been turned off for the purposes of this demonstration. Using previously spun up file \~ 12 hours, run multiple times.
...
input_rhessys = IOin_rhessys_input(
  version = rh_path,
  tec_file = "tecfiles/tec_daily",
  world_file = "CWWS7ssurgo.world.Y2018M11D1H1.state",
  world_hdr_prefix = "CWWS7ssurgo",
  flowtable = "CWWS7ssurgo.flow",
  start = "1775 11 1 1",
  end = "2018 11 2 1",
...
input_rhessys = IOin_rhessys_input(
  version = rh_path,
  tec_file = "tecfiles/tec_daily",
  world_file = "CWWS7dsm.world",
  world_hdr_prefix = "cwws7dsm",
  flowtable = "cwws7dsm.flow",
  start = "1775 11 1 1",
  end = "2018 11 2 1",
  output_folder = "out",
  output_prefix = "cwws7",
...
input_rhessys = IOin_rhessys_input(
  version = rh_path,
  tec_file = "tecfiles/tec_daily",
  world_file = "cwws7dsm.world.Y2018M11D1H1.state",
  world_hdr_prefix = "cwws7dsm",
  flowtable = "cwws7dsm.flow",
  start = "1775 11 1 1",
  end = "2018 11 2 1",
...
setwd(system.file("extdata/", package = "RHESSysIOinR"))
read_clim("clim/cwtws7daymet.rain", dates_out = TRUE)

input_rhessys = IOin_rhessys_input(
  version = rh_path,
  tec_file = "tecfiles/tec_daily",
  world_file = "CWWS7.world.Y2018M11D1H1.state.Y2018M11D1H1.state",
  world_hdr_prefix = "CWWS7",
  flowtable = "CWWS7.flow",
  start = "2014 11 1 1",
  end = "2018 11 2 1",
  output_folder = "out",
...
input_hdr = IOin_hdr(
  ...
  landuse = "defs/lu_undev.def",
  stratum = c("defs/veg_deciduous/veg_deciduous.def","defs/veg_evergreen/veg_evergreen.def","defs/veg_deciduous_BES.def","defs/veg_eucalypt.def","defs/veg_grass.def","defs/veg_lawn_2cm.def","defs/veg_lawn_5cm.def","defs/veg_lawn_10cm.def","defs/veg_nonveg.def"),
  basestations = "clim/cwtws7local.base")
...
patchfilter = build_output_filter(
  ...
  output_filename = "ws7basin_daily",
  spatial_level = "basin",
...
singleruntest<- readin_rhessys_output("out/cwws7_runsingle")
...
singlerunfiltertest<- read_delim("outputfilter/ws7basin_daily_single.csv", delim = ",")
