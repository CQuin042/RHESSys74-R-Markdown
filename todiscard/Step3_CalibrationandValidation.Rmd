---
title: "RHESSysIOinR_Coweeta_WS32_74 Multi Site Validation Field Data_Step3"
...
input_tec_data = IOin_tec_std(start = "2016 11 1 1",
                              end = "2018 11 1 1",
                              output_state = TRUE)
...
input_rhessys = IOin_rhessys_input(
  version = rh_path,
  tec_file = "tecfiles/tec_daily",
  world_file = "CWWS32.world.Y2018M11D1H1.state",
  world_hdr_prefix = "CWWS32",
  flowtable = "CWWS32.flow",
  start = "2014 11 1 1",
  end = "2018 11 2 1",
