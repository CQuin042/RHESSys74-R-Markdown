...
testoutput<- readin_rhessys_output("out/cwws32_run5")
...
{plot(cwws32_run3$bd$date,cwws32_run3$bd$streamflow, type = "l", col = 'red', main = "Observed Streamflow vs Top Runs", xlab = "Date", ylab = "Streamflow")
lines(cwws32_run5$bd$date,cwws32_run5$bd$streamflow, col = 'blue')
...
{plot(cwws32_run4$bd$date,cwws32_run4$bd$streamflow, type = "l", col = 'red', main = "Observed Streamflow vs Top Runs", xlab = "Date", ylab = "Streamflow", ylim = c(0,10))
