...
```{r Run RHESSYS in Parallel using foreach Static, echo=TRUE}
setwd(system.file("extdata/", package = "RHESSysIOinR"))
n.cores <- parallel::detectCores() - 4  
...
```{r Run RHESSYS in Parallel using foreach SSURGO, echo=TRUE}
setwd(system.file("extdata/", package = "RHESSysIOinR"))
n.cores <- parallel::detectCores() - 4  
...
```{r Run RHESSYS in Parallel using foreach DSM, echo=TRUE}
